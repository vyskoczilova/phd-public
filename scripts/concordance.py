...
class ConcordanceRow:
	...
	def kwic_has_lemma(self, lemma, last_word_only=False):
		if last_word_only:
			...
			if "/" + lemma + "/" in last_word:  # místo "/" pokud by nebyly tagy
				return True
		elif "/" + lemma + "/" in self.kwic:  # místo "/" pokud by nebyly tagy
			return True
		return False
...
class POS:
	def __init__(self):
		...
		self.second = {
			...
			"P6": "reflexívní zájmeno „se“ v dlouhých tvarech („sebe“, „sobě“, „sebou“)",
			"P7": "reflexívní zájmeno „se“, „si“ pouze v těchto tvarech, a dále „ses“, „sis“",
